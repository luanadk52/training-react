 ...
 * Sử dụng các custom hooks và tối ưu với useMemo, useCallback
 */
function TodoApp() {
  ...
  // Tính toán counts - sử dụng useMemo để tối ưu
  ...
  // Filter function dựa trên filterType - sử dụng useCallback
  ...
  // Sử dụng custom hook useFilter với memoized filter function
  const filteredTasks = useFilter(tasks, getFilterFunction());

  // Callback handlers - tối ưu với useCallback
